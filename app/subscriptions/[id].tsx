    ...
    <Modal visible={visible} animationType="slide" transparent onRequestClose={onClose}>
      <View className="flex-1 justify-end bg-black/40">
        ...
        <View style={{ backgroundColor: colors.background, maxHeight: "88%" }} className="rounded-t-3xl">
          ...
          <Pressable onPress={onClose} style={{ alignSelf: "stretch" }} className="w-full p-3 items-center">
            <ThemedText style={{ textAlign: "center", width: "100%" }} tone="muted" className="text-base font-semibold">
              Cancel
            </ThemedText>
          </Pressable>
          </KeyboardAwareScrollView>
